...
function Dashboard({ user }) {
  ...
  useEffect(() => {
    ...
    api.get("/dashboard/recent").then((res) => {
      setRecent(res.data);
    });
    api
      .get(`/dashboard/my-responsibilities/${user.businessRole}`)
      .then((res) => {
  ...
  return (
    ...
    >
        ...
        <div className="mb-4">
          ...
          >
            <div className="card-body p-4">
              ...
              <div className="mb-2">{user.businessRole}</div>
              ...
              <div className="opacity-75">ATLANTA QUÍMICA • SARI</div>
          ...
          <div className="col-lg-6 mb-4">
            <div className="card shadow-sm border-0 h-100">
              <div className="card-body">
                <h5 className="fw-bold mb-4">System Compliance</h5>
            ...
            <div className="card shadow-sm border-0 h-100">
              <div className="card-body">
                <div className="d-flex justify-content-between align-items-center mb-4">
                  <h5 className="fw-bold mb-0">Pending Workflow Actions</h5>
                        ...
                        <div className="fw-semibold">
                          <span
                            className={`badge me-2 ${
                              p.type === "PRO" ? "bg-primary" : "bg-success"
                            }`}
                          >
                            {p.type}
                          </span>
      ...
      <div className="card shadow-sm border-0 mt-4">
        <div className="card-body">
          <div className="d-flex justify-content-between align-items-center mb-4">
            <h5 className="fw-bold mb-0">👤 My Responsibilities</h5>
          </div>
          ...
          <div className="row text-center">
            <div className="col-md-3">
              <div className="border rounded p-3">
                ...
                <h3 className="mt-2">{responsibilities.assignedPros}</h3>

                <div className="text-muted">Assigned PROs</div>
              </div>
            </div>
            ...
            <div className="col-md-3">
              <div className="border rounded p-3">
                ...
                <h3 className="mt-2">{responsibilities.assignedRecords}</h3>

                <div className="text-muted">Assigned Records</div>
              </div>
            </div>
            ...
            <div className="col-md-3">
              <div className="border rounded p-3">
                ...
                <h3 className="mt-2">{responsibilities.pendingReview}</h3>
            ...
            <div className="col-md-3">
              <div className="border rounded p-3">
                ...
                <h3 className="mt-2">{responsibilities.pendingApproval}</h3>
      ...
      <div className="card shadow-sm border-0 mt-4">
        <div className="card-body">
          <div className="d-flex justify-content-between align-items-center mb-4">
            <h5 className="fw-bold mb-0">Recent Controlled Documents</h5>

            <span className="badge bg-primary">{recent.length}</span>
          </div>
                ...
                {recent.map((doc, index) => (
                  <tr key={index}>
                    ...
                    <td>
                      <span
                        className={`badge ${
                          doc.type === "PRO" ? "bg-primary" : "bg-success"
                        }`}
                      >
                        {doc.type}
                      </span>
...
function ComplianceRow({ label, value, color, total }) {
