    ...
    <div className="container mt-4">
      ...
      <div className="card shadow-sm mb-3">
        <div className="card-header d-flex justify-content-between align-items-center">
          <h5 className="mb-0">📋 Form Templates</h5>

          <button
            className="btn btn-primary"
            onClick={() => setShowUploadForm(!showUploadForm)}
          >
            {showUploadForm ? "Close Upload" : "Upload Template"}
          </button>
        </div>
      </div>
          ...
          <div className="card-body">
            ...
            <input
              ...
              onChange={(e) => {
                ...
                const match = filename.match(/^([A-Z]+-\d+-[A-Z])\s+(.+)$/);
                ...
                if (match) {
                  ...
                  alert(
                    "Filename must follow:\n\nPRO-14-B Encuesta Satisfacción Proveedor",
                  );
      ...
      <div className="card shadow">
        <div className="card-header bg-dark text-white d-flex justify-content-between align-items-center">
          ...
          <span className="badge bg-light text-dark">{forms.length}</span>
        </div>
        ...
        <div className="card-body">
          {forms.map((f) => (
            <div key={f.id}>
              ...
              >
                <div>
                  <div className="fw-bold">{f.code}</div>
        ...
        "
            >
              <div>
                ...
                <h4 className="mb-0">{selectedTemplate.title}</h4>
              </div>
